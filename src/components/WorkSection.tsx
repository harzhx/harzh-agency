                  ...
                  <div className="relative aspect-video rounded-2xl md:rounded-[26px] overflow-hidden bg-black group">
                    {isPlaying ? (
                      ...
                      >
                        ...
                        {/* Top Badges (Subtle & Floating Creator Proof) */}
                ...
                >
                  {isPlaying ? (
                    ...
                    >
                      ...
                      {/* Top Creator Proof Pill */}
                      <div className="absolute top-3 left-3 right-3 flex items-center justify-between z-10">
                        <span className="px-3 py-1 rounded-full bg-black/80 backdrop-blur-md text-xs font-semibold text-emerald-400 border border-white/15 flex items-center gap-1.5">
