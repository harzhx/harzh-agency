...
export const StrategiesSection: React.FC<StrategiesSectionProps> = ({
  ...
  const processSteps = [
    {
      step: 1,
      title: "Topic Ideation & Hook Strategy",
      tag: "THE FOUNDATION",
      desc: "We help identify high-demand video concepts and craft an irresistible opening hook before you record, so your video starts with built-in viewer interest.",
      icon: <Zap className="w-4 h-4 text-amber-400" />,
    },
    {
      step: 2,
      title: "Story Assembly & Dynamic Pacing",
      tag: "DYNAMIC PACING",
      desc: "We strip away awkward pauses, repetitive tangents, and dead air—building a rhythmic narrative flow that keeps viewers engaged throughout the entire video.",
      icon: <Activity className="w-4 h-4 text-indigo-400" />,
    },
    {
      step: 3,
      title: "Motion Graphics & Visual Polish",
      tag: "THE 1% CRAFT",
      desc: "Custom on-screen animations, clean B-roll, 3D overlays, and kinetic typography that visualize complex ideas and elevate your brand aesthetic.",
      icon: <ImageIcon className="w-4 h-4 text-purple-400" />,
    },
    {
      step: 4,
      title: "Tactile Sound Design & Mastering",
      tag: "IMMERSIVE AUDIO",
      desc: "Studio vocal leveling, tactile sound effects (foley, whooshes, risers), and dynamic music scoring that give your videos emotional depth and weight.",
      icon: <Volume2 className="w-4 h-4 text-cyan-400" />,
    },
    {
      step: 5,
      title: "Packaging & Retention Diagnostics",
      tag: "THE FEEDBACK LOOP",
      desc: "We design high-contrast A/B thumbnails to win the click, and analyze your YouTube Studio drop-off curves after publishing to feed real data back into your next upload.",
