    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-0.5 lg:gap-1 p-1 lg:p-1.5 rounded-full bg-white/[0.03] border border-white/[0.08] backdrop-blur-md">
            {navLinks.map((link, idx) => (
              <a
                key={idx}
                href={link.href}
                onClick={(e) => handleNavClick(e, link.href)}
                className="px-3 lg:px-4 py-1.5 lg:py-2 text-[11px] lg:text-xs font-semibold text-white/70 hover:text-white rounded-full hover:bg-white/[0.08] transition-all duration-200 cursor-pointer"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center gap-2 lg:gap-4">
            ...
            <button
              ...
              className="px-4 lg:px-5 py-2 lg:py-2.5 rounded-full text-[11px] lg:text-xs font-bold bg-white text-black hover:bg-white/90 hover:shadow-[0_0_25px_rgba(255,255,255,0.4)] transition-all flex items-center gap-1.5 lg:gap-2 active:scale-95 shadow-xl cursor-pointer whitespace-nowrap"
            >
