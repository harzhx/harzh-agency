...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    id: "work-1",
    title: "High-Adrenaline Esports Velocity & Motion Tracking",
    creator: "Ares Esports / Pro FPS",
    creatorAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=160&auto=format&fit=crop&q=80",
    channelSubscribers: "320K Subs",
    category: "longform",
    views: "640K",
    retentionRate: "64.2%",
    ctr: "12.8%",
    ...
    tags: ["Velocity Pacing", "Hand-Cam Sync", "Motion Tracking", "Letterbox 4K"],
    keyEdits: [
  ...
  {
    id: "work-2",
    title: "Complete Bridal Transformation: Pacing & Cost Callouts",
    creator: "Simran Kaur Makeovers",
    creatorAvatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=160&auto=format&fit=crop&q=80",
    channelSubscribers: "700K+ Subs",
    category: "longform",
    views: "1.4M",
    retentionRate: "68.5%",
    ctr: "14.2%",
    ...
    tags: ["UI Step Badges", "Cost Overlays", "Color Grading", "700K+ Creator"],
    keyEdits: [
  ...
  {
    id: "work-3",
    title: "Calisthenics & Strength Masterclass: Pacing & Power",
    creator: "Elite Calisthenics Hub",
    creatorAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=160&auto=format&fit=crop&q=80",
    channelSubscribers: "480K Subs",
    category: "longform",
    views: "890K",
    retentionRate: "62.8%",
    ctr: "13.6%",
    ...
    tags: ["Kinetic Subtitles", "Gym Storytelling", "High-Energy Cut", "Sound Foley"],
    keyEdits: [
    ...
    beforeAfterComparison: {
      ...
      rawPacing: "Average watch time: 1m 50s (28% retention)",
      editedPacing: "Average watch time: 7m 30s (62.8% retention)",
    },
  },
  {
    id: "work-4",
