...
export const PRICING_PACKAGES: PricingTier[] = [
  {
    ...
    billingPeriod: "/ month",
    description: "For creators scaling short-form or repurposing long-form to shorts.",
    deliverables: [
      ...
      "Multi-platform formatting for Shorts, Reels & TikTok",
      "Unlimited revisions",
      "Dedicated Editor + private communication channel",
    ],
  ...
  },
  {
    ...
    billingPeriod: "/ month",
    description: "End-to-end management for creators scaling their YouTube channel.",
    deliverables: [
      "4 Long-form YouTube master edits (up to 20 mins)",
      "High-retention pacing & storytelling",
      "High-CTR Packaging: 3 titles & 2 thumbnails per video",
      "Custom animations, clean lower-thirds & b-roll",
      "Sound design, audio mastering & color grading",
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Complete High-CTR packaging: Titles & thumbnails per video",
      "Custom 2D/3D motion graphics & intro animations",
      "Weekly 1-on-1 strategy call to review growth",
